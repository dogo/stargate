...
Full user documentation: [`README.md`](README.md) (1227 lines — it is the reference, do not
duplicate it here). Verified single-vendor configurations: [`examples/`](examples/).

## Repository state

**Both modes are implemented and covered.** 199 tests, all passing (`make test`, exit 0).
